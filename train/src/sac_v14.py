...
# SAC_v14_20 no C
# SAC_v14_21 no C
# SAC_v14_22 no pow 3 1000 singularity no stop
# SAC_v14_23 no joint info  15000 no pow
# SAC_v14_24 all 800 no pow
# SAC_v14_25 no C no pow 800
...
class SAC(object):
    def __init__(self, act_dim, obs_dim, lr_actor, lr_value, gamma, tau, buffers, alpha=0.2, name=None, seed=1):
        ...
        self.writer = tf.summary.FileWriter('/home/yue/SAC_0610/src/Collision_Avoidance/train/logs/'+NAME+'/'+self.name+'/', self.sess.graph)
        self.saver = tf.train.Saver()
        self.path = '/home/yue/SAC_0610/src/Collision_Avoidance/train/weights/'+ NAME +'/'+ self.name
